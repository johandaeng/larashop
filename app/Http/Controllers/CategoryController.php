...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('categories.index')->with('status','Category successfuly created');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('categories.index',['id'=> $id])->with('status','Category succesfully update');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('categories.index')->with('status','Category successfully to trash');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('categories.index')->with('status','Category successfuly restored');
    }
